...
export class AddBeneficiaryComponent implements OnInit {
  ...
  error_messages = {
    ben_name: [
      ...
      {
        type: 'maxLength',
        message: 'Beneficiary name cannot exceed 50 alphabets',
      },
    ],
    ben_acc_num: [
      ...
      {
        type: 'minlength',
        message: 'Beneficiary account number must be 15 digits',
      },
    ],
    Re_enterAccount_num: [
      { type: 'required', message: 'Account number is required' },
      ...
      { type: 'minlength', message: 'Account number be 15 digits' },
      {
        type: 'Valid',
        message:
          'Entered Account number mismatches with the Beneficiary Accountnumber',
      },
    ],
